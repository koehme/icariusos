DEPENDENCIES = ./obj/pm.o ./obj/icarius.o ./obj/vga.o ./obj/idt.asm.o ./obj/idt.o ./obj/io.asm.o ./obj/string.o ./obj/mem.o ./obj/heap.o ./obj/cursor.o ./obj/page.o ./obj/page.asm.o ./obj/ata.o ./obj/plexer.o ./obj/pparser.o ./obj/keyboard.o ./obj/timer.o
