...
image:
	i686-elf-ld --no-warn-rwx-segments -n -T ./linker.ld ./obj/multiboot.o ./obj/loader.o ./obj/kernel.o ./obj/ata.o ./obj/cmos.o ./obj/cursor.o ./obj/keyboard.o ./obj/timer.o ./obj/vga.o ./obj/pci.o ./obj/mouse.o ./obj/pathlexer.o ./obj/pathparser.o ./obj/stream.o ./obj/vnode.o ./obj/idt.o ./obj/idt.asm.o ./obj/io.asm.o ./obj/heap.o ./obj/page.o ./obj/page.asm.o ./obj/string.o ./obj/vfs.o ./obj/fat16.o -o ./bin/ICARIUS.BIN
