...
sudo cp ./iso/grub/boot/grub/grub.cfg /mnt/boot/grub/grub.cfg
sudo cp ./bin/x86/ICARIUS.BIN /mnt/boot/ICARIUS.BIN

sudo cp -r ./bin/x86/BIN /mnt/
sudo cp -r ./bin/x86/DEV /mnt/
sudo cp -r ./bin/x86/ETC /mnt/    
sudo cp -r ./bin/x86/TMP /mnt/  
